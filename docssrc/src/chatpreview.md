...
```java,Spigot
{{#include ../../commandapi-examples/src/test/dev/jorel/commandapi/examples/java/Examples.java:chatpreviewspigot}}
```

```java,Paper
{{#include ../../commandapi-examples/src/test/dev/jorel/commandapi/examples/java/Examples.java:chatpreviewadventure}}
```
...
```java,Spigot
{{#include ../../commandapi-examples/src/test/dev/jorel/commandapi/examples/java/Examples.java:chatpreviewspigotusepreview}}
```

```java,Paper
{{#include ../../commandapi-examples/src/test/dev/jorel/commandapi/examples/java/Examples.java:chatpreviewadventureusepreview}}
```
