...
```java,Java
{{#include ../../commandapi-documentation-code/src/test/dev/jorel/commandapi/examples/java/Examples.java:ArgumentSuggestions1}}
```

```kotlin,Kotlin
{{#include ../../commandapi-documentation-code/src/test/dev/jorel/commandapi/examples/kotlin/Examples.kt:ArgumentSuggestions1}}
```
...
```java,Java
public {{#include ../../commandapi-documentation-code/src/test/dev/jorel/commandapi/examples/java/Examples.java:ArgumentSuggestions2_1}}
```

```kotlin,Kotlin
{{#include ../../commandapi-documentation-code/src/test/dev/jorel/commandapi/examples/kotlin/Examples.kt:ArgumentSuggestions2_1}}
```
...
```java,Java
{{#include ../../commandapi-documentation-code/src/test/dev/jorel/commandapi/examples/java/Examples.java:ArgumentSuggestions2_2}}
```

```kotlin,Kotlin
{{#include ../../commandapi-documentation-code/src/test/dev/jorel/commandapi/examples/kotlin/Examples.kt:ArgumentSuggestions2_2}}
```
...
```java,Java
{{#include ../../commandapi-documentation-code/src/test/dev/jorel/commandapi/examples/java/Examples.java:ArgumentSuggestionsPrevious}}
```

```kotlin,Kotlin
{{#include ../../commandapi-documentation-code/src/test/dev/jorel/commandapi/examples/kotlin/Examples.kt:ArgumentSuggestionsPrevious}}
```
