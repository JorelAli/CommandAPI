...
public class ExceptionHandlingArgumentSerializer_1_16_R2<T> extends ExceptionHandlingArgumentSerializer_Common<T, PacketDataSerializer> implements ArgumentSerializer<ExceptionHandlingArgumentType<T>> {
