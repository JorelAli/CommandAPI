...
import net.minecraft.server.v1_16_R2.ArgumentPredicateItemStack;
...
public class NMS_1_16_R2 extends NMSWrapper_1_16_R2 {
	...
	public void reloadDataPacks() {
		...
		try {
			CommandAPIHandler.getField(CustomFunctionManager.class, "h").set(datapackResources.a(), getBrigadierDispatcher());
		} catch (IllegalArgumentException | IllegalAccessException e1) {
			e1.printStackTrace();
		}
