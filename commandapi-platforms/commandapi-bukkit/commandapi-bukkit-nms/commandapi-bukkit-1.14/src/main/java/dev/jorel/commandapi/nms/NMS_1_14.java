...
import org.bukkit.craftbukkit.v1_14_R1.help.CustomHelpTopic;
...
/**
 * NMS implementation for Minecraft 1.14, 1.14.1 and 1.14.2
 */
...
public class NMS_1_14 extends NMSWrapper_1_14 {
	...
	@Differs(from = "1.13.2", by = "Implement _ArgumentTime()")
	@Override
	...
	@Differs(from = "1.13.2", by = "this.<MinecraftServer>getMinecraftServer().getFunctionData().a() is now Optional-wrapped")
	@Override
	...
	@Differs(from = "1.13.2", by = "ArgumentVec2I.a -> BlockPosition2D")
	@Override
	...
	@Differs(from = "1.13.2", by = "uses getLootTableRegistry().a() instead of reflection call to LootTableRegistry.e")
	@Override
	public SuggestionProvider<CommandListenerWrapper> getSuggestionProvider(SuggestionProviders provider) {
		return switch (provider) {
			...
			case ADVANCEMENTS -> (cmdCtx, builder) -> ICompletionProvider.a(this.<MinecraftServer>getMinecraftServer().getAdvancementData().b().stream().map(Advancement::getName), builder);
	...
	@Differs(from = "1.13.2", by = "Implement TimeArgument")
	@Override
