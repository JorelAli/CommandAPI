...
public class ExceptionHandlingArgumentSerializer_1_17_Common<T> extends ExceptionHandlingArgumentSerializer_Common<T, FriendlyByteBuf> implements ArgumentSerializer<ExceptionHandlingArgumentType<T>> {
