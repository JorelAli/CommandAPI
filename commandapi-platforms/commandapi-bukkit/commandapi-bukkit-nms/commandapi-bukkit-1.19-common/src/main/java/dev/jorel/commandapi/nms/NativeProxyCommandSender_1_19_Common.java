...
public class NativeProxyCommandSender_1_19_Common extends ProxiedNativeCommandSender implements NativeProxyCommandSender {
	private final World world;
	private final Location location;

	public NativeProxyCommandSender_1_19_Common(CommandSourceStack css, CommandSender caller, CommandSender callee) {
