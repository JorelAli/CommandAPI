...
public class ExceptionHandlingArgumentSerializer_1_16_4_R3<T> extends ExceptionHandlingArgumentSerializer_Common<T, PacketDataSerializer> implements ArgumentSerializer<ExceptionHandlingArgumentType<T>> {
	...
	public ExceptionHandlingArgumentType<T> b(PacketDataSerializer packetDataSerializer) {
		...
		throw new IllegalStateException("This shouldn't happen! See dev.jorel.commandapi.nms.ExceptionHandlingArgumentSerializer_1_16_4_R3#b for more information");
