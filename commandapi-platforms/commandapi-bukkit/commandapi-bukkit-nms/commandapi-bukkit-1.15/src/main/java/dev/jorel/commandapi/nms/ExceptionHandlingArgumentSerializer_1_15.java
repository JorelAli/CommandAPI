...
public class ExceptionHandlingArgumentSerializer_1_15<T> extends ExceptionHandlingArgumentSerializer_Common<T, PacketDataSerializer> implements ArgumentSerializer<ExceptionHandlingArgumentType<T>> {
