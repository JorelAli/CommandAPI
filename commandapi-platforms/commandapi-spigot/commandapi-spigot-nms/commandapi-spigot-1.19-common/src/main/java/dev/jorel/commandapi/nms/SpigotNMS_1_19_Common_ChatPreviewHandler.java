...
public abstract class SpigotNMS_1_19_Common_ChatPreviewHandler extends ChannelDuplexHandler {

	protected final CommandAPISpigot<CommandSourceStack> platform;
	protected final Plugin plugin;
	protected final Player player;
	protected final Connection connection;

	protected SpigotNMS_1_19_Common_ChatPreviewHandler(CommandAPISpigot<CommandSourceStack> platform, Plugin plugin, Player player) {
	...
	public MutableComponent parseChatPreviewQuery(String chatPreviewQuery) {
		...
		return Component.Serializer.fromJson(jsonToSend);
	}
	...
	private record InitialParse(String fullInput, ParseResults<CommandSourceStack> results, List<String> path, Optional<PreviewableFunction<?>> preview){
		...
		public static InitialParse processChatPreviewQuery(String chatPreviewQuery, CommandAPISpigot<CommandSourceStack> platform, Player player){
