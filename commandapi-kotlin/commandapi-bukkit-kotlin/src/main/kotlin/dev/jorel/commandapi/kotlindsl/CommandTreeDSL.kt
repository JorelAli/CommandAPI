...
inline fun CommandTree.entitySelectorArgumentManyEntities(nodeName: String, optional: Boolean = false, block: Argument<*>.() -> Unit = {}): CommandTree = addArgument(EntitySelectorArgument.ManyEntities(nodeName), optional, block)
...
inline fun CommandTree.entitySelectorArgumentManyPlayers(nodeName: String, optional: Boolean = false, block: Argument<*>.() -> Unit = {}): CommandTree = addArgument(EntitySelectorArgument.ManyPlayers(nodeName), optional, block)
...
inline fun Argument<*>.entitySelectorArgumentManyEntities(nodeName: String, optional: Boolean = false, block: Argument<*>.() -> Unit = {}): Argument<*> = addArgument(EntitySelectorArgument.ManyEntities(nodeName), optional, block)
...
inline fun Argument<*>.entitySelectorArgumentManyPlayers(nodeName: String, optional: Boolean = false, block: Argument<*>.() -> Unit = {}): Argument<*> = addArgument(EntitySelectorArgument.ManyPlayers(nodeName), optional, block)
