...
import net.minecraft.server.v1_13_R2.ArgumentSerializer;
...
public class ExceptionHandlingArgumentSerializer_1_13_1<T> implements ArgumentSerializer<ExceptionHandlingArgumentType<T>> {
	...
	public ExceptionHandlingArgumentType<T> b(PacketDataSerializer packetDataSerializer) {
		...
		throw new IllegalStateException("This shouldn't happen! See dev.jorel.commandapi.nms.ExceptionHandlingArgumentSerializer_1_13_1#deserializeFromNetwork for more information");
