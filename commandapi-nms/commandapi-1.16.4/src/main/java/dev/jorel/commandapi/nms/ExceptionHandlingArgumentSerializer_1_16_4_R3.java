...
public class ExceptionHandlingArgumentSerializer_1_16_4_R3<T> implements ArgumentSerializer<ExceptionHandlingArgumentType<T>> {
	...
	public ExceptionHandlingArgumentType<T> b(PacketDataSerializer packetDataSerializer) {
		...
		throw new IllegalStateException("This shouldn't happen! See dev.jorel.commandapi.nms.ExceptionHandlingArgumentSerializer_1_15#deserializeFromNetwork for more information");
