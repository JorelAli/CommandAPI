...
import net.minecraft.server.v1_14_R1.ArgumentSerializer;
...
public class ExceptionHandlingArgumentSerializer_1_14<T> implements ArgumentSerializer<ExceptionHandlingArgumentType<T>> {
	...
	public ExceptionHandlingArgumentType<T> b(PacketDataSerializer packetDataSerializer) {
		...
		throw new IllegalStateException("This shouldn't happen! See dev.jorel.commandapi.nms.ExceptionHandlingArgumentSerializer_1_14#b for more information");
