# Documentation for v1.4

An API to use the new command UI introduced in Minecraft 1.13

## This documentation is outdated! See [version 1.5](https://github.com/JorelAli/1.13-Command-API/blob/master/v1.5%20Documentation.md) for the documentation on version 1.5!

## Installation (For server owners)
* Download the v1.4 CommandAPI.jar from the download page [here](https://github.com/JorelAli/1.13-Command-API/releases/tag/v1.4)
