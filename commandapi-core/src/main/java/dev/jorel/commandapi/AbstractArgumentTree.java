 ...
 */
public abstract class AbstractArgumentTree<CommandSender> extends Executable<AbstractArgumentTree<CommandSender>, CommandSender> {
	 ...
	 */
	public AbstractArgumentTree<CommandSender> then(final AbstractArgumentTree<CommandSender> tree) {
