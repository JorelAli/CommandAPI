...
public interface CommandExecutionInfo extends IExecutorNormal<CommandSender> {
	 ...
	 */
	@Override
	void run(CommandSender sender, Object[] args, Map<String, Object> argsMap) throws WrapperCommandSyntaxException;
