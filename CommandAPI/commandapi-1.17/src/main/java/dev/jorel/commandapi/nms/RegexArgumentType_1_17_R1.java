...
public class RegexArgumentType_1_17_R1 implements ArgumentType<String> {
	
	public static final void register() {
		ArgumentTypes.register("regex", RegexArgumentType_1_17_R1.class, new RegexArgumentSerializer());
	}

	public Pattern pattern;
	public String errorMessage;
	
	public RegexArgumentType_1_17_R1(String pattern, String errorMessage) {
	...
	static class RegexArgumentSerializer implements ArgumentSerializer<RegexArgumentType_1_17_R1> {

		@Override
		public void serializeToNetwork(RegexArgumentType_1_17_R1 argument, FriendlyByteBuf packetByteBuf) {
		...
		@Override
		public RegexArgumentType_1_17_R1 deserializeFromNetwork(FriendlyByteBuf packetByteBuf) {
		...
		@Override
		public void serializeToJson(RegexArgumentType_1_17_R1 argument, JsonObject jsonObject) {
